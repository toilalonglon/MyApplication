...
#define WINDOW_ICON_PATH L"mario.icon"
...
void LoadResources()
{
	...
	textures->Add(1, L"textures\\misc.png", D3DCOLOR_XRGB(156, 219, 239));

	CSprites * sprites = CSprites::GetInstance();
	
	LPDIRECT3DTEXTURE9 texMario = textures->Get(ID_TEX_MARIO);
	LPDIRECT3DTEXTURE9 texBrick = textures->Get(1);
	...
	sprites->Add(20001, 300, 117, 315, 132, texBrick);
	sprites->Add(20002, 318, 117, 333, 132, texBrick);

	sprites->Add(20003, 336, 117, 351, 132, texBrick);
	sprites->Add(20004, 354, 117, 369, 132, texBrick); 
	...
	LPANIMATION ani2;
	ani2 = new CAnimation(100);
	ani2->Add(20001);
	ani2->Add(20002);
	
	animations->Add(1000, ani2);
	...
	*/
	...
	Brick = new CBrick(BRICK_START_X, BRICK_START_Y, BRICK_START_VX);
}
